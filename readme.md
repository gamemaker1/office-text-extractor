...
> from version 3.0.0 onwards, this package can be used in browsers.

to use this package in the browser, fetch it using a cdn like `esm.sh`/`jsdelivr.com`:

```
<script type="module">
  import { getTextExtractor } from 'https://esm.sh/office-text-extractor@latest/web'
</script>
```
